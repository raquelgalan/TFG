...
### SALÓN, SALA COLINDANTE LATERAL CON DIVISIÓN VERTICAL
...
# Arrays vacíos
LpR_Salon_F1 = []           # Array para los resultados del nivel de presión en recepción
...
if __name__ == "__main__":
    print()
    print('NIVELES EN RECEPCIÓN SALÓN - FUENTE 1')
    print('------------------------------------------------------')
    print('Frecuencia | Lp salón')
    print('------------------------------------------------------')
    Calcular_Lp(87, 107, 4, 8, 5, LpR_Salon_F1)
    Resultados(LpR_Salon_F1, 'dB')

    print()
    print('NIVELES EN RECEPCIÓN SALÓN - FUENTE 2')
    print('-------------------------------------------------------')
    print('Frecuencia | Lp salón')
    print('-------------------------------------------------------')
    Calcular_Lp(87, 107, 9, 13, 5, LpR_Salon_F2)
    Resultados(LpR_Salon_F2, 'dB')
    ...
    print()
    print('NIVELES CORREGIDOS EN RECEPCIÓN - SALÓN - FUENTE 2')
    print('-------------------------------------------------------------------')
    print('Frecuencia | Lp Corregido SALÓN')
    print('-------------------------------------------------------------------')
    ...
    print()
    print('NIVELES EN EMISIÓN SALÓN - FUENTE 1')
    print('---------------------------------------------------')
    print('Frecuencia | Lp SALÓN')
    print('---------------------------------------------------')
    Calcular_Lp(87, 107, 17, 21, 5, LpE_Salon_F1)
    Resultados(LpE_Salon_F1, 'dB')

    print()
    print('NIVELES EN EMISIÓN SALÓN - FUENTE 2')
    print('---------------------------------------------------')
    print('Frecuencia | Lp SALÓN')
    print('---------------------------------------------------')
    Calcular_Lp(87, 107, 22, 26, 5, LpE_Salon_F2)
    Resultados(LpE_Salon_F2, 'dB')
    ...
    print()
    print('DIFERENCIA DE NIVEL - SALÓN - FUENTE 1')
    print('------------------------------------------------------------------')
